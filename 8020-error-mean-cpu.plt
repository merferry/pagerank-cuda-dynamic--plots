...
set output '8020-error-mean-cpu.pdf'
...
set label "On CPU" at screen 0.89,0.91 center font ",14"
plot '8020.csv' \
     using 4:($15) title 'Static' linestyle  1 with linespoints, \
  '' using 4:($16) title 'ND'     linestyle  2 with linespoints, \
  '' using 4:($17) title 'DT'     linestyle  3 with linespoints, \
  '' using 4:($18) title 'DF'     linestyle  4 with linespoints, \
  '' using 4:($19) title 'DF-P'   linestyle  5 with linespoints
